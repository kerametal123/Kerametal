...
Namespace kerametal
    Public Class ConnectionHelper
        Const ConnectionString As String = "XpoProvider=MySql;server=127.0.0.1;user id=root; password=samael89; database=kerametal;persist security info=true;CharSet=utf8;"
